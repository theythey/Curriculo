        ...
        <div class="modal-body">
            ...
            <div class="form-group"style="padding: 10px;!important">
                ...
                <select class="form-select form-select-sm" name="contabanc" aria-label=".form-select-sm example">
                  ...
                  <option value="BANCO BRASIL">BB</option>
                </select>
            </div>
        </div>
...
echo'<tr>';
    ...
    echo '<h5>'. 'Nome' . ':'.  '</h5>';
    echo '<h5 class="card-title" style="margin-left: 5px;" >'. $row['razao'] .'</h5>';
    echo '</div>';
    echo '<div style="display:flex;">';
    echo '<h6 >'. 'CNPJ: ' . '</h6>';
    echo '<h6 class="card-title" style="margin-left: 5px;">'. $row['cnpj'] . '</h6>';
echo '</div>';
    echo '<div style="display:flex;">';
    echo '<h6 class="card-subtitle mb-2 text-muted"> '. 'Contas:' . '</h6>';
    echo '<h6 class="card-subtitle mb-2 text-muted" style="margin-left: 5px;">' . $row['contas'] . '</h6>';
echo '</tr>';
  echo '</div>';
echo '</div>';
}
